...
window.AI_STACK_TOOLS = [
  ...
  },
  {
    id: 'sora',
    name: 'Sora',
    description: 'OpenAI\'s retired video generation product. The app and web experience closed on April 26, 2026; the API ends September 24, 2026.',
    bestFor: 'Reference only — see Google Veo, Runway, or Google Flow for current text-to-video workflows.',
    ...
    summary: 'Sora was OpenAI\'s video generation product for creating and editing short videos from text prompts, images, and video inputs. It is being retired: OpenAI announced the wind-down on March 24, 2026, closed the Sora app and web experience on April 26, 2026, and has scheduled the Sora API for discontinuation on September 24, 2026. Anyone who generated work in Sora should export it before the remaining deadline; the entry is kept here for reference and for tracing where video workflows moved next.',
    ...
    notGoodFor: 'Not good for any new workflow: the product is being retired, so nothing built on it should be treated as durable. Even before the wind-down it was a poor fit for guaranteed factual realism, fully deterministic outputs, or frame-accurate post-production in the way a traditional NLE or VFX suite handles it.',
    officialTrainingDocs: [
  ...
  // Presentations - Core Tools
  {
    ...
    name: 'Gemini Notebook Slide Decks',
    formerNames: 'Formerly NotebookLM Slide Decks',
    description: 'Create slide decks directly from your documents and notes inside Gemini Notebook (formerly NotebookLM).',
  ...
  {
    id: 'llama-3-meta',
    name: 'Meta open models (Llama, Muse)',
    formerNames: 'Listed previously as Llama 3 (Meta)',
    description: 'Meta\'s open-weight model line for chat, coding, tool use, and deployable application development, now spanning Llama and the newer Muse family.',
    bestFor: 'Open-model chat, coding, and self-hosted application workflows across cloud and edge.',
    uses: 'Open Source LLM, Chat, Coding, Instruction Following, Multilingual Tasks, Fine-Tuning, Self-Hosted Deployment, Application Development, Research, Edge/On-Prem Inference, Local Agents',
    tags: ['LLM', 'Open Model', 'Developer'],
    tier: 'Free',
    logoUrl: 'https://picsum.photos/seed/llama3/200/200',
    url: 'https://www.llama.com/',
    parentCompany: 'Meta',
    summary: 'Meta\'s open-weight models are built for developers, researchers, and enterprises that want deployable models they can run, fine-tune, and integrate across cloud, on-prem, and edge environments. Llama 3.x remains the widely deployed generation. In 2026 Meta moved its frontier work to the Muse family: Muse Spark shipped as a proprietary API model, and Muse Glimmer — a 30B multimodal model distilled for local agentic use and released under Apache 2.0 on August 10, 2026 — returned the line to open weights. Meta has said it also intends to open the Muse Spark 1.2 weights. Check which family a project targets before committing, because the naming is still in flux.',
  ...
  },
  {
    ...
    formerNames: 'Formerly NotebookLM (renamed July 16, 2026)',
    description: 'Google\'s source-grounded research and learning assistant for synthesis with citations and generated study outputs. Renamed from NotebookLM in July 2026.',
    bestFor: 'Source-grounded research, study guides, briefings, audio overviews, and collaborative note workflows.',
    uses: 'Source-Grounded Research, Document Synthesis, Study Guide Creation, Audio Overviews, Briefing Generation, Mind Mapping, Flashcard Creation, Quiz Generation, Slide Deck Generation, Data Analysis, Collaborative Research, Note-Taking',
    tags: ['Research', 'Learning', 'Google'],
    tier: 'Freemium',
    logoUrl: 'https://picsum.photos/seed/notebooklmtool/200/200',
    url: 'https://notebook.google.com/',
    parentCompany: 'Google',
    summary: 'Gemini Notebook — the product Google shipped as NotebookLM until July 16, 2026 — is Google\'s AI research and learning assistant for understanding, organizing, and synthesizing information from your own sources. It supports grounded chat with inline citations and can turn source material into study guides, briefings, audio overviews, mind maps, quizzes, infographics, and slide decks. The rename came with closer Gemini app integration and a code-execution feature that lets the assistant write and run code against the material in a notebook for native data analysis. Existing notebooks, shared links, and the notebooklm.google.com address carry over; the product now lives at notebook.google.com.',
    tagCategories: 'AI research assistant, learning assistant, study tool, knowledge management, research workflow, document analysis, source-grounded AI, note-taking tool, productivity, education technology, enterprise AI, business productivity, multimodal AI, writing assistant, summarization tool, study assistant, knowledge work, citation-based AI, collaborative research, document intelligence, Google ecosystem, Workspace tool, academic productivity, professional productivity, AI notebook, synthesis tool, source analysis, briefing tool, research companion, learning technology, NotebookLM',
    features: 'grounded chat with inline citations, source upload and discovery, PDF support, website support, YouTube support, audio file support, Google Docs support, Google Slides support, source-based summarization, study guide generation, briefing generation, audio overviews, video overviews, mind maps, flashcards, quizzes, infographic generation, slide deck generation, code execution for data analysis on supported plans, Gemini app integration, note creation, save chat to notes, note-to-source conversion, notebook sharing, viewer and editor permissions, collaboration, mobile app support, multilingual support, export notes to Google Docs, export notes to Google Sheets, higher limits on paid plans, enterprise data protection on supported plans',
    notGoodFor: 'Not good for fully open-ended chat without source grounding, guaranteed factual accuracy when sources are weak or missing, or replacing expert judgment in high-stakes legal, medical, or financial decisions. It is also a weaker fit when the user wants a general-purpose assistant rather than a source-based research and synthesis workspace.',
    officialTrainingDocs: [
      'https://support.google.com/notebooklm/',
...
window.AI_STACK_DISCONTINUED_META = {
  generatedAt: '2026-08-10',
  timezone: 'America/Los_Angeles',
  scopeWindow: { start: '2023-01-01', end: '2026-08-10' },
};

window.AI_STACK_DISCONTINUED = [
  {
    ...
    reasonDiscontinued: 'OpenAI announced the product sunset, advised exports before shutdown, and closed the app and web experience on April 26, 2026.',
    datesActive: { appLaunchDate: '2025-09-30', announcedShutdownDate: '2026-03-24', endOfAppWeb: '2026-04-26' },
